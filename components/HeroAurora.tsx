...
export default function HeroAurora({
  badge = "Trusted community clinic",
  headline = "Compassionate care for every stage of life",
  subheadline = "Harborview Health combines trusted clinicians, modern diagnostics, and telehealth access to keep your family healthy.",
  ...
  return (
    <AuroraBackground
      auroraColors={["#10b981", "#059669", "#34d399", "#a7f3d0", "#6ee7b7"]}
    >
      <motion.div
