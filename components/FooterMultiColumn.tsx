...
const defaultColumns: FooterColumn[] = [
  {
    ...
    links: [
      ...
      { label: "Telehealth Visits", href: "/services/telehealth" },
    ],
  },
  {
    title: "Patients",
...
export default function FooterMultiColumn({
  ...
  description = "Compassionate primary care, specialty services, and telehealth designed around your family’s needs.",
