...
export default function HeroWaves({
  title = "TRAIN HARDER. MOVE FASTER.",
  subtitle = "Elite training sessions, electric energy, and a community that refuses to settle.",
  ctaLabel = "Book a Free Class",
  ctaHref = "#trial",
  secondaryCtaLabel = "See Class Schedule",
  secondaryCtaHref = "#classes",
  waveColors = ["#ef4444", "#f97316", "#ef4444", "#f97316", "#ef4444"],
}: HeroWavesProps) {
  return (
    <WavyBackground
      colors={waveColors}
    ...
    >
      <div className="relative z-10 flex flex-col items-center justify-center px-4 text-center">
        <TextGenerateEffect
          words={title}
          className="text-4xl font-bold text-white md:text-6xl lg:text-7xl uppercase"
        />
        {subtitle && (
