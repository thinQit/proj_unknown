...
export default function HeroImage({
  ...
  headline = "Find Your Signature Residence",
  subheadline = "Curated luxury listings, discreet representation, and a seamless buying journey with Aurelia Estates.",
  primaryCta = { label: "Explore Listings", href: "/listings" },
  secondaryCta = { label: "Schedule a Showing", href: "/contact" },
